...
def detect_location_info(text: str, nlp: spacy.Language) -> Dict:
    ...
    if (
        ...
        recommendations.append(
            "Consider reducing location mentions. "
...
def _calculate_semantic_similarity(
    ...
    """
    Lightweight similarity calculation using RapidFuzz.

    SentenceTransformer/PyTorch was previously used here.
    RapidFuzz provides a much lighter alternative suitable
    ...
    try:
        # token_set_ratio handles word order and repeated words
...
def _skill_matches(
    ...
    # Fast direct substring match
    if skill and skill.lower() in text.lower():
        return True, 1.0

    # Lightweight fuzzy similarity
